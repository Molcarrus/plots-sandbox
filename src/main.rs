...
fn main() -> Result<(), eframe::Error> {
    ...
    eframe::run_native(
        "Plots-Sandbox", 
        options, 
        Box::new(|cc| Ok(Box::new(Sandbox::new(cc))))
    )
}
...
impl Surface {
    ...
    fn project_points(
        ...
        for row in &self.vertices {
            for vertex in row {
                ...
                let projected_y = rotated.z as f64;
    ...
    fn get_wireframe_lines(
        ...
        for i in 0..=self.resolution {
            ...
            lines
                .push(Line::new(format!("row_{}", i), PlotPoints::new(line_points))
        ...
        for j in 0..=self.resolution {
            ...
            lines
                .push(Line::new(format!("col_{}", j), PlotPoints::new(line_points))
                .color(egui::Color32::from_gray(180))
                .width(1.0));
        }
...
fn color_from_height(height: f64) -> egui::Color32 {
    ...
    if height < 0.5 {
        let t = height * 2.0;
        let (r, g, b) = ((t * 255.0) as u8, (t * 255.0) as u8, ((1.0 - t) * 255.0) as u8);
        egui::Color32::from_rgb(r, g, b)
    } else {
        let t = (height - 0.5) * 2.0;
        let (r, g, b) = (255, ((1.0 - t) * 255.0) as u8, 0);
        egui::Color32::from_rgb(r, g, b)
    }
}

fn rotation_matrix(x_deg: f32, y_deg: f32, z_deg: f32) -> Mat3 {
    let (x_rad, y_rad, z_rad) = (x_deg.to_radians(), y_deg.to_radians(), z_deg.to_radians());
    let (rot_x, rot_y, rot_z) = (Mat3::from_rotation_x(x_rad), Mat3::from_rotation_y(y_rad), Mat3::from_rotation_z(z_rad));
...
impl eframe::App for Sandbox {
    fn update(&mut self, ctx: &egui::Context, frame: &mut eframe::Frame) {
        ...
        egui::SidePanel::left("side_panel").show(ctx, |ui| {
            ...
            ui.label("- Hyperbloic: sinh, cosh, tanh");
